...
import { CreateEstadoController } from '@modules/common/use-cases/estado/create-estado/create-estado-controller'
import { ListEstadoController } from '@modules/common/use-cases/estado/list-estado/list-estado-controller'
import { CountEstadoController } from '@modules/common/use-cases/estado/count-estado/count-estado-controller'
import { SelectEstadoController } from '@modules/common/use-cases/estado/select-estado/select-estado-controller'
import { IdSelectEstadoController } from '@modules/common/use-cases/estado/id-select-estado/id-select-estado-controller'
import { GetEstadoController } from '@modules/common/use-cases/estado/get-estado/get-estado-controller'
import { UpdateEstadoController } from '@modules/common/use-cases/estado/update-estado/update-estado-controller'
import { DeleteEstadoController } from '@modules/common/use-cases/estado/delete-estado/delete-estado-controller'
import { MultiDeleteEstadoController } from '@modules/common/use-cases/estado/multi-delete-estado/multi-delete-estado-controller'
...
estadosRoutes.get('/', ensureAuthenticated, listEstadoController.handle)
